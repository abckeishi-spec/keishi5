...
<section class="clean-search-section">
    <div class="clean-container">
        ...
        <div class="clean-filters">
            <button class="clean-filter-pill <?php echo empty($search_params['status']) && empty($search_params['is_featured']) ? 'active' : ''; ?>" data-filter="all">
                すべて
            </button>
            <button class="clean-filter-pill <?php echo $search_params['is_featured'] === '1' ? 'active' : ''; ?>" data-filter="featured">
                おすすめ
            </button>
            <button class="clean-filter-pill <?php echo $search_params['status'] === 'active' ? 'active' : ''; ?>" data-filter="active">
                募集中
                <?php if ($stats['active_grants'] > 0): ?>
                <span class="clean-filter-count"><?php echo $stats['active_grants']; ?></span>
                <?php endif; ?>
            </button>
            <button class="clean-filter-pill" data-filter="high-rate">
                高採択率
            </button>
            <button class="clean-filter-pill" data-filter="large-amount">
                1000万円以上
            </button>
            <button class="clean-filter-pill" data-filter="easy">
                申請簡単
            </button>
            <button class="clean-filter-pill" data-filter="online">
                オンライン申請
            </button>
        </div>
    </div>
    ...
    <div class="clean-container">
        <div class="clean-controls-inner">
            <div class="clean-controls-left">
                ...
                <button id="clean-filter-toggle" class="clean-filter-button">
                    <i class="fas fa-sliders-h"></i>
                    フィルター
                    <span id="clean-filter-count" class="clean-filter-count" style="display:none">0</span>
                </button>
            </div>
...
<section class="clean-main">
    <div class="clean-container">
        <div class="clean-layout">
            ...
            <!-- Sidebar Filters -->
            <aside id="clean-filter-sidebar" class="clean-sidebar">
                <div class="clean-filter-card">
                    <div class="clean-filter-header">
                        <h3 class="clean-filter-title">詳細フィルター</h3>
                        <button id="clean-filter-close" class="clean-filter-close">
                            <i class="fas fa-times"></i>
                        </button>
                    </div>
...
(function() {
    ...
    function showLoading() {
        ...
        if (container && !container.querySelector('.clean-loading-overlay')) {
            ...
            overlay.innerHTML = '<div class="clean-spinner"></div>';
